...
import "./login.css";
import side_img from "../Assests/image 13.png";
const Login = () => {
  ...
  const validate = (values) => 
  {
    ...
    if(!values.c_box){errors.c_box="Check this box if you want to proceed";}
      ...
      <form onSubmit={handleSubmit}>
          ...
          <p className="errormsg">{formErrors.mobile}</p>
           ...
           <label className="c_box"> 
            <input type="checkbox" onChange={handleChange} name="c_box"/>Share my registration data with Superapp</label>
